...
// Railway mounts a writable volume at /data, fallback to local data folder
...
collections.sessions   = new Datastore({ filename: path.join(dbPath, "sessions.db"),   autoload: true });
