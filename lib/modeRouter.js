...
//    Provide support-button and Hotlines guidance at a natural moment — never as a cold redirect.
//    Never end on resources alone — stay emotionally present.
//
//  CRITICAL_ESCALATION — critical (immediacy / imminent danger)
//    Local emergency services in first sentence (mandatory).
...
function resolveMode(state) {
  ...
  // CRITICAL: imminent danger — local emergency services lead the response
